...
・石原 康臣,(2020).「デジタルサイネージ研究」『研究ノート』

・酒井宏平，豊田祐輔，鐘ヶ江秀彦,(2018).「観光客の防災意識に 影響する要因に関する研究-世界遺産姫路城を事例に-」，『歴史都市防災論文集』, Vol.12，pp.1–8. 

・坂本真輝,吉野孝,永井隼人,佐野楓,ブレント・リッチー(2019).「観光客を対象とした防災情報提示システムにおける観光防災地図作り機能の開発」年度情報処理学会関西支部 支部大会https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&ved=2ahUKEwjV36i9hOf1AhUP3WEKHYdyA_4QFnoECAgQAQ&url=https%3A%2F%2Fipsj.ixsq.nii.ac.jp%2Fej%2F%3Faction%3Drepository_uri%26item_id%3D200268%26file_id%3D1%26file_no%3D1&usg=AOvVaw09eBaKCNpKPzDXOb4cAEbr

・中村 伊知哉,(2013).「デジタルサイネージの動向」『情報管理』55 巻 12 号 p. 891-898

・三宅正史,佐瀬文隆,櫛引紀人,中平輝人,(2017).「デジタルサイネージ等を活用した実用的な防災情報提供システム&サービスに関する一考察」,『情報処理学会研究報告』,Vol.2017-GN-100 No.25
...
### ③広告媒体としての可能性
・人の位置移動による状況即応型デジタルサイネージ

　　映像ディスプレイ前の人の位置移動に基づきリアルタイムでコンテンツを選択し、人々にタイミング良く情報提示する即応型デジタルサイネージ
  
・デジタルサイネージとモバイル端末を連携させた複数人同時閲覧のための情報提示システム

　　モバイル端末を用いてデジタルサイネージ上で各自の操作ができ，複数ユーザーが同時に任意のコンテンツの詳細をモバイル端末上で閲覧できる 
  
・インタラクティブデジタルサイネージシステムと携帯電話による歩行者誘導

　　アイキャチ効果の高い魅力的な広告など、街の様々なスポットに人の流れを作る街づくりのプラットフォーム
...
　筆者が観光で伊豆大島を訪れた際、設置されているデジタルサイネージをほとんど認識したなかった。また、そもそも旅行先で被災するはとほとんど想定しておらず、過去のような水害や火山による災害、土砂崩れが起きた時にどのように行動するのかわからなかった。液晶を複数繋げて大きなサイズのデジタルサイネージを作るなど通行人の注意を引く、訴求力の高いものを作る工夫が必要だ。



## まとめ

本論文では特に伊豆大島のような観光地において、防災や災害時の情報提供のツールとしてのデジタルサイネージの有用性を検討した。今後は伊豆大島での実装を通し、デジタルサイネージの活用や防災意識を向上させるコンテンツを検討したい。
